    ...
    return(
        <div className="bg-white rounded-3xl mt-6 p-6 shadow-sm">
            ...
            <div className=" flex justify-end mb-6">
                <button className="bg-gray-100 flex px-5 py-3 rounded-2xl font-medium hover:bg-gray-200">
                    <Plus size={20}/>
                    New Task
                </button>
            </div>

            <div className="grid grid-cols-5 text-gray-500 text-sm font-semibold border-b pb-4">
                <p>TASK</p>
                <p>CATEGORY</p>
                <p>STATUS</p>
                <p>CREATED</p>
            ...
            <div className="grid grid-cols-5 items-center py-5 border-b border-gray-500">
                <div>
